...
public class TriangleTest {
	...
	/* Checking Minimal double input values */
	@Test
	...
	/* Checking Maximal double input values */
	@Test
	...
	/* Checking Maximal exponent input values */
	@Test
	...
	/* Checking mixes with minimal and maximal double input values */
	@Test
	...
	/* INVALID test cases */
	/* Checking (a + b) < c case with Integer format input values */
	@Test
	...
	/* Checking (a + b) < c case with Floating point format input values */
	@Test
	...
	/* Checking (a + b) < c case with exponential format input values */
	@Test
	...
	/* Checking (a + b) < c case with different format input values */
	@Test
	...
	/* Checking for Negative input value */
	@Test
	...
	/* Checking for (a + b) = c input values */
	@Test
	...
	/* Checking for Positive infinity input value */
	@Test
	...
	/* Checking for Negative infinity input value */
	@Test
